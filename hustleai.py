...
from utils import (UPLOAD_DIR, CHECKLIST_DIR, load_json, save_json, get_ip,
                   extract_skills_from_pdf, generate_hustles, generate_single_hustle,
                   generate_checklist, bottom_nav)
# Page config
